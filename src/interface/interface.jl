...
similar(s::AbstractSystem, precision::Type{<:AbstractFloat}; reserve_dynamic::Bool=false, reserve_static::Bool=false) = _NI("similar")
...
eachatom(s::AbstractSystem) = _NI("eachatom")
...
add_hierarchy!(s::AbstractSystem, names::AbstractVector{<:AbstractString}) = _NI("add_hierarchy!")
...
add_labels!(s::AbstractSystem, hname::AbstractString, labels::Union{Tuple, Base.Generator, <:AbstractVector}) = _NI("add_labels!")
...
add_relations!(s::AbstractSystem, hname::AbstractString; super::HLabel, sub::Union{Tuple, Base.Generator, <:AbstractVector{HLabel}}) = _NI("add_relations!")
...
super_labels(s::AbstractSystem, hname::AbstractString, label::HLabel) = _NI("super_labels")
super_labels(s::AbstractSystem, hname::AbstractString, atom::Integer) = _NI("super_labels")
sub_labels(s::AbstractSystem, hname::AbstractString, label::HLabel) = _NI("sub_labels")
sub_labels(s::AbstractSystem, hname::AbstractString, atom::Integer) = _NI("sub_labels")
...
similar_system(traj::AbstractTrajectory, precision::Type{<:AbstractFloat}; reserve_dynamic::Bool=false, reserve_static::Bool=false) = _NI("similar_system")
